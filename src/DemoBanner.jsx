...
const CHECKOUT_URL = 'https://vnckxwbzbmtdqsvgrnfg.supabase.co/functions/v1/create-checkout?submission_id=474aba1d-e45a-418a-94ca-0fef74cabf77'
  ...
  return (
    <div className="dark">
        ...
        >
          ...
          >
            ...
            <CardContent className="relative z-10 p-5 sm:p-10">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-5 mb-5 sm:mb-8">
                ...
                <Card className="rounded-2xl relative overflow-hidden" style={{ borderColor: `rgba(${ACCENT_RGB}, 0.3)`, backgroundColor: `rgba(${ACCENT_RGB}, 0.05)` }}>
                  ...
                  <CardContent className="p-4 sm:p-6 flex flex-col h-full">
                    ...
                    <Button asChild className="w-full rounded-full font-semibold mt-auto animate-btn-glow" style={{ backgroundColor: ACCENT, color: '#000', '--glow-rgb': ACCENT_RGB }}>
              ...
              <Card className="rounded-2xl overflow-hidden mb-5 sm:mb-8 relative" style={{ borderColor: `rgba(${ACCENT_RGB}, 0.2)`, background: `linear-gradient(135deg, rgba(${ACCENT_RGB}, 0.08) 0%, rgba(${ACCENT_RGB}, 0.02) 50%, rgba(${ACCENT_RGB}, 0.06) 100%)` }}>
                <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none">
                  <div className="absolute top-0 left-0 w-full h-[1px] overflow-hidden">
                    <div className="w-1/3 h-full animate-shimmer-slide" style={{ background: `linear-gradient(to right, transparent, rgba(${ACCENT_RGB}, 0.6), transparent)` }} />
                  </div>
                </div>
                <CardContent className="relative p-5 sm:p-8 text-center">
                  <div className="inline-flex w-12 h-12 rounded-2xl items-center justify-center mb-4" style={{ backgroundColor: `rgba(${ACCENT_RGB}, 0.1)`, border: `1px solid rgba(${ACCENT_RGB}, 0.15)` }}>
                    <Sparkles className="w-6 h-6" style={{ color: ACCENT }} />
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-3">Need a fully custom website or advanced features?</h3>
                  <p className="text-sm sm:text-base text-zinc-400 mb-1.5 max-w-xl mx-auto">If your business requires more than a standard setup — such as unique design, complex integrations, or tailored functionality — we've got you covered.</p>
                  <p className="text-sm sm:text-base text-zinc-300 mb-5 max-w-xl mx-auto">Schedule a quick discovery call and we'll prepare a solution built specifically for your goals.</p>
                  <Button asChild className="rounded-full font-semibold gap-2 animate-btn-glow" style={{ backgroundColor: ACCENT, color: '#000', '--glow-rgb': ACCENT_RGB }}>
      ...
      <style>{`
        ...
        @keyframes btn-glow { 0%, 100% { box-shadow: 0 0 12px 2px rgba(var(--glow-rgb), 0.4), 0 0 24px 4px rgba(var(--glow-rgb), 0.2); } 50% { box-shadow: 0 0 20px 4px rgba(var(--glow-rgb), 0.6), 0 0 40px 8px rgba(var(--glow-rgb), 0.3); } }
        ...
        .animate-btn-glow { animation: btn-glow 2s ease-in-out infinite; }
